...
define([
        ...
        'nbextensions/external/aws-sdk',
        'nbextensions/external/browser-bunyan',
        'nbextensions/external/@browser-bunyan/server-stream',
        'nbextensions/external/@browser-bunyan/console-raw-stream',
        'nbextensions/external/kinesiswritable',
